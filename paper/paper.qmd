...
The data set used for this analysis was sourced from Jacob Filipp's Project Hammer, a project with the goal of "increasing competition" and "reducing collusion" in the Canadian grocery market [@citeData]. This data set contains time series data of grocery prices, collected from major food retailers in Canada in the year 2024. Additional information such as brand information, unit description, and product name were also collected and assigned a product id.

The data used for this analysis was sourced from Jacob Filipp's Project Hammer, a project with the goal of "increasing competition" and "reducing collusion" in the Canadian grocery market - cite. The raw data consists of two data sets, one containing product information of groceries at popular Canadian food retailers, and the other containing the time series data of product prices. The conjoined data set is large and has over 10,000 entries.
